...
//        });
        ...
        $('#add-btn').click(function() {
            ...
            isi += "<td><input type=\"text\" id=\"trfangkutan-" + i + "\" class=\"trfa-" + i + "\" name=\"trfangkutan[]\" style=\"width:100px;\" /></td>";
            ...
            $('.trfa-' + i).change(function() {
                ...
                var trf = $('#trfangkutan-' + no).val();
                var jml = $('#jumlah-' + no).val();


                if (trf != "" && jml != "") {
                    var total = trf * jml;
                    $('#jmltrans-' + no).val(total);
                }
            });
        ...
        $('.trfa-1').keyup(function() {
            ...
            var trf = $('#trfangkutan-1').val();
            var jml = $('#jumlah-1').val();


            if (trf != "" && jml != "") {
                var total = trf * jml;
                $('#jmltrans-1').val(total);
            }
        });
        $('.trfhari-1').keyup(function() {

            var trf = $('#jharian-1').val();
        ...
        $('.add-harian-btn').click(function() {
            ...
            isi += "<td><input type=\"text\" name=\"jharian[]\" id=\"jharian-" + j + "\" class=\"trfhari-" + j + "\" style=\"width:140px;\"/></td>";
        ...
        $('#calculate').click(function() {
            ...
            $('#total-angkutan').val(total);

            var totalharian = parseInt($('#total-harian').val());
            ...
            if (totalharian != "") {
                ...
                $('#total-biaya').html(" : Rp. " + totalsemua);
                $('#sisa-sekarang').html(" : Rp. " + sisa_anggaran);
            }
            return false;
        });
        $('#calculate-harian').click(function() {
            ...
            $('#total-harian').val(total);


            var totalangkutan = parseInt($('#total-angkutan').val());
...
//                    echo form_close();
    ...
    if ($res->job_code == 'FIA') {
        ...
        ?>
            ...
            ?>
            <button id="perincian-btn">Input/Update Perincian Biaya</button>
        </fieldset>
            <?php
        }
        ?>
            ...
            <table style="width:850px; text-align: center; font-size: smaller;">
                <tbody id="main-angkutan-body">
                    ...
                    <tr id="row-1" style="border-bottom: 1px dotted black;">
                        ...
                        <td><input type="text" id="trfangkutan-1" name="trfangkutan[]" class="trfa-1" style="width:100px;" /></td>
                    ...
                    <tr id="row-<?php echo $j; ?>" style="border-bottom: 1px dotted black;">
                        ...
                        <td><input type="text" id="trfangkutan-<?php echo $j; ?>" name="trfangkutan[]" class="trfa-<?php echo $j; ?>" style="width:100px;" value="<?php echo $rowangkutan->transport_fee; ?>"/></td>
            ...
            <table style="text-align: center; width: 850px; font-size: smaller;">
                <tbody id="data-body">
                    ...
                    <tr id="row-harian-1">
                        ...
                        <td><input type="text" name="jharian[]" id="jharian-1" class="trfhari-1" style="width:140px;"/></td>
                    ...
                    <tr id="row-harian-<?php echo $i; ?>">
                        ...
                        <td><input type="text" name="jharian[]" id="jharian-<?php echo $i; ?>" class="trfhari-<?php echo $i; ?>" style="width:140px;" value="<?php echo $rowharian2->day_amount; ?>"/></td>
